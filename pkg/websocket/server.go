...
var (
	...
	ErrBadRequestMethod    = errors.New("websocket: bad method")
	ErrNotWebSocket        = errors.New("websocket: not websocket protocol")
	ErrBadWebSocketVersion = errors.New("websocket: missing or bad WebSocket Version")
	ErrChallengeResponse   = errors.New("websocket: mismatch challenge/response")
)
